...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   pars_of_map_help_bonus.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: yhajji <yhajji@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/17 19:26:14 by yhajji            #+#    #+#             */
/*   Updated: 2025/02/20 17:55:46 by yhajji           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	validate_map_conditions(t_game *game)
{
	...
	if (!ft_is_valid_path(game))
		ft_error_msg("Invalid map: No valid path exists ", game);
}
